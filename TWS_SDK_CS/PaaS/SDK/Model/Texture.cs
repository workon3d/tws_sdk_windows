...
namespace PaaS.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Texture :  IEquatable<Texture>
    { 
        ...
        public Texture(int? TextureId = null, string Name = null)
        {
        ...
        /// <summary>
        /// Returns true if Texture instances are equal
        /// </summary>
        /// <param name="other">Instance of Texture to be compared</param>
        /// <returns>Boolean</returns>
