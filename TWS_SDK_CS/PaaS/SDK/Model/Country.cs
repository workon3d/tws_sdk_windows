...
namespace PaaS.SDK.Model
{
    ...
    { 
        ...
        /// <param name="Name">ex) United States.</param>
        /// <param name="Abbreviation">ex) USA.</param>
        /// <param name="Buid">business unit ID.</param>

        public Country(int? Id = null, string Name = null, string Abbreviation = null, int? Buid = null)
        {
            this.Id = Id;
            this.Name = Name;
